...
LOCAL_APPS = [
    "core_apps.user_auth", "core_apps.user_profile", "core_apps.common", "core_apps.accounts", "core_apps.cards"
]
...
DEFAULT_COUNTRY = "NG"
DEFAULT_PHONE_NUMBER = "+2348109092234"
...
SPECTACULAR_SETTINGS = {
    "TITLE": "Djan Bank API",
    "DESCRIPTION": "Djan Bank API official docs.",
    "VERSION": "1.0.0",
