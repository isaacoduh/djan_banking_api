...
class NextOfKin(TimeStampedModel):
    ...
    date_of_birth = models.DateField(_("Date Field"))
    ...
    class Meta:
        constraints = [
            models.UniqueConstraint(fields=['profile', 'is_primary'], condition=models.Q(is_primary=True), name="unique_primary_next_of_kin")
        ]
