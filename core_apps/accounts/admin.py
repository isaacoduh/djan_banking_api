...
class BankAccountAdmin(admin.ModelAdmin):
    list_display = ['account_number', 'user', 'currency', 'account_type', 'account_balance', 'account_balance', 'account_status', 'is_primary', 'kyc_verified', 'get_verified_by',]
    list_filter = ['currency', 'account_type', 'account_status', 'is_primary','kyc_submitted', 'kyc_verified']
    search_fields = ['account_number', 'user__email','user__first_name', 'user__last_name']
    readonly_fields = ["account_number", "created_at", "updated_at"]
    fieldsets = (
        (
            None, {"fields": ("user", "account_number", "account_balance", "currency", "account_type", "is_primary")}
        ),
        (
            _("Status"),
            {
