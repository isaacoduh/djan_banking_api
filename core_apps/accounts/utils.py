...
def generate_account_number(currency: str) -> str:
    ...
    currency_codes = {
        ...
        "nigeria_naira": getenv("CURRENCY_CODE_NGN"),
    }
...
def create_bank_account(user, currency: str, account_type: str) -> str:
    with transaction.atomic():
        ...
        bank_account = BankAccount.objects.create(user=user, account_number=account_number, currency=currency, account_type=account_type, is_primary=is_primary)
