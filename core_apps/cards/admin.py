...
class VirtualCardAdmin(admin.ModelAdmin):
    list_display = ["card_number", "user_full_name","bank_account_number", "expiry_date","balance","status"]
    list_filter = ["status","expiry_date"]
    search_fields = ["card_number", "user__email", "user__first_name", "user__last_name", "bank_account__account_number"]
